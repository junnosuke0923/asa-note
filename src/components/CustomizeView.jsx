  ...
  return (
    <div className="ink-line blob-b bg-paper px-3 py-3">
      <div className="flex gap-3">
        {/* 絵 */}
        <div className="flex w-[124px] shrink-0 flex-col items-center gap-1.5">
          <div className="ink-line blob-b flex size-[120px] items-center justify-center overflow-hidden bg-warm-yellow">
            <AppImage
              src={set.image}
              size={112}
              fallback={<Sprout size={76} className="opacity-45" />}
            />
          </div>
    ...
    <>
      ...
      {DECORATION_SLOTS.map((slot) => (
        <div key={slot.id} className="ink-line blob-b flex items-center gap-3 bg-paper px-3 py-3">
          <div className="ink-line blob-b flex size-[120px] shrink-0 items-center justify-center overflow-hidden bg-warm-yellow">
            <AppImage src={decorations[slot.id]} size={112} fallback={FALLBACKS[slot.id]} />
          </div>
